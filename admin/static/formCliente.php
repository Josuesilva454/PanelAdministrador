...
<script>
    $(function(){
        $('#editarModal').on('show.bs.modal', function (event) {
            ...
            var modal = $(this)
         //aplica valor ao id
            modal.find('.modal-title').text('Excluindo dados: ' + titulo)
            modal.find('#titulo').val(titulo) // <input type="text" class="form-control" id="nome" name="nome" placeholder="Nome Completo" required autocomplete="off">
                                ...
                                <form enctype='multipart/form-data' method='post' action="cadastroCliente.php" >
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="titulo"
                                            name='titulo' required autocomplete="off">
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Descrição</label>
                                        <input type="descricao" class="form-control" id="descricao"
                                            name='descricao' required autocomplete="off">
                                    </div>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <button type="button" class="btn btn-secondary" data-bs-toggle="modal" data-bs-target="#editarModal" data-id = '<?php echo $id ?>' data-titulo="<?php echo $titulo ?>"
                                                 data-descricao="<?php echo $descricao ?>"data-foto="<?php echo $foto ?>">
